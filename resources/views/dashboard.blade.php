                ...
                <div class="col-lg-10 col-md-10 col-sm-10">
                    <div class="content-timeline">
                        ...
                        <div class="text-content-timeline">
                            Lorem Ipsum Dolor is simply a dummy text. Lorem Ipsum Dolor is simply a dummy text. Lorem Ipsum Dolor is simply a dummy text. Lorem Ipsum Dolor is simply a dummy text. Lorem Ipsum Dolor is simply a dummy text.
                        </div>
                            ...
                            <div class="comments-content">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="content-comment">
                                        ...
                                        <div class="responds-timeline">
                                            <a href="#">
                                                <div class="like-comment"><span class="icon-timeline"><i class="zmdi zmdi-thumb-up"></i></span><span class="like-count-timeline">0</span> likes</div>
                                            </a>
                                            <a href="#">
                                                <div class="comment-comment"><span class="icon-timeline"><i class="zmdi zmdi-comments"></i></span><span class="comment-count-timeline">48</span> comments</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
